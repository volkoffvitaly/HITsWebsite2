    ...
    public class DataProviderService : IDataProviderService
    {
        ...
        public async Task<List<CityFeature>> GetCityFeaturesWithPhotos()
        {
            return await _context.CityFeatures.Include(x => x.CityFeatureTranslations).Include(x => x.Pictures)
                                               .Where(x => x.Pictures.Count != 0).AsNoTracking().ToListAsync();
        }
        ...
        public async Task CreateRequest(RequestCreateModel model)
        {
        ...
        public async Task ChangeBlockName(String projectBlockName, MainPageBlockEditModel model)
        {
